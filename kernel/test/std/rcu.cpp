...
static void AddElement(sm::RcuDomain<Tree>& domain, Tree *root, Tree *element) {
    sm::RcuGuard<Tree> guard(domain);
    Tree *current = root;
...
static void DeleteElement(sm::RcuDomain<Tree>& domain, Tree *root, uint8_t data) {
    sm::RcuGuard<Tree> guard(domain);
    Tree *parent = root;
    Tree *current = root;
    bool left = false;
...
static bool FindElement(sm::RcuDomain<Tree>& domain, Tree *root, uint64_t data) {
    sm::RcuGuard<Tree> guard(domain);
    Tree *current = root;
...
static void DestroyTree(sm::RcuDomain<Tree>& domain, Tree *root) {
    sm::RcuGuard<Tree> guard(domain);
