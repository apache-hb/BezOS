...
namespace km {
    ...
    void InitSmp(km::SystemMemory& memory, km::IApic *bsp, const acpi::AcpiTables& acpiTables, km::IsrTable *ist, std::atomic_flag *launchScheduler, std::atomic<uint32_t>* remaining);
}
